...
const [quote, setQuote] = useState<Quote>({ quotes: "", author: "" });
  return (
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          >
            <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 h-full transform transition-all duration-300">
              ...
              <p className="text-blue-600 dark:text-blue-400 font-medium mb-4 text-center">
              ...
              <div className="flex justify-center space-x-4 mb-6">
                {socialLinks.map((link , index) => (
                  <motion.a
                    ...
                    className="w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-blue-100 dark:hover:bg-blue-800 transition-colors text-xl"
            ...
            <div className="text-center mb-4">
                <QuoteFetcher onQuoteLoaded={setQuote} />
              <p className="text-gray-600 dark:text-gray-300 mb-2">"{quote.quotes}"</p>
          ...
          <div className="w-full lg:w-2/3 order-1 lg:order-2 space-y-8">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                experience in creating modern web applications. I specialize in
                JavaScript frameworks like React and Next.js, and I'm committed
                to building accessible and user-friendly websites.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                My approach combines technical expertise with creative
                problem-solving to deliver solutions that not only meet but
                exceed client expectations. I'm constantly learning and adapting
